initially(john,has,0,peach).
happens(john,buy,11,peach,none,1).
happens(john,eat,9,peach,none,2).
...
holdsAt(P,V,NumOld,Obj,T):- happens(P1,Act,Num,Obj,P2,T1), (T1 < T), initiates(P1,Act,Num,Obj,P2,P,V,NumOld,Obj,T1), (\+clipped(T1,P,V,NumOld,Obj,T)).
